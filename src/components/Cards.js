...
const Cards = () => {
  ...
  return (
    ...
    data.map((e,i)=>{
       ...
       <Link to={`/detail/${e.id}`}><div key={i} className='cards text-sm md:text-lg shadow-xl w-40 sm:w-44 md:w-60 h:56 sm:h-80 md:h-96 font-semibold  p-2 hover:-translate-y-4 cursor-pointer mt-6 transition-all duration-500 rounded-lg '>
